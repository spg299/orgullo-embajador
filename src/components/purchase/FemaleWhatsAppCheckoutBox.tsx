...
// Mirrors WhatsAppCheckoutBox.tsx exactly (same countdown-before-redirect
// flow, same message format) except it posts to /api/checkout-femenino —
// the men's WhatsAppCheckoutBox.tsx is untouched and not imported here.
const checklist = [
...
export default function FemaleWhatsAppCheckoutBox({
  match,
  selections,
  subtotal,
  total,
  ...
  function handleFinalize() {
    ...
    const lines = [
      "Hola, quiero finalizar mi compra de boletas (Fútbol Femenino):",
      "",
