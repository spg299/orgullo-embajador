  ...
  return (
    <div className="rounded-3xl border border-navy-900/8 bg-white shadow-card">
      <div className="border-b border-navy-900/8 p-6">
        ...
        <div className="mt-4 space-y-1.5 text-xs text-navy-700/60">
      ...
      <div className="p-6">
        {selections.length === 0 ? (
          <p className="rounded-xl bg-royal-50/60 px-4 py-6 text-center text-sm text-navy-700/50">
        ...
        <div className="mt-6 space-y-2.5 border-t border-navy-900/8 pt-5 text-sm">
          ...
          <div className="flex items-center justify-between border-t border-dashed border-navy-900/10 pt-3 text-base font-bold text-navy-950">
            <span>Total</span>
